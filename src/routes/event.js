...
const { addevent, addfood, addDecor, getResponses, getEvents, registerResponses, acceptBid, getEvent, updateBid, completed, getCompleted, getCompletedCompany } = require('../controller/event');
